<template>
    <section class="h-[90dvh] flex flex-col md:flex-row gap-x-5 gap-y-5 items-center justify-center">
        ...
        <router-link :to="{ name: 'renewal' }" class="bg-custom-primary w-1/3 md:w-1/4 lg:w-1/6 py-2 text-center text-white rounded-md border hover:bg-gray-100 hover:border-custom-primary hover:text-custom-primary">Renewal</router-link>
