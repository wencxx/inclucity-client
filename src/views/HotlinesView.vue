<template>
     <section class="h-[90dvh] font-poppins overflow-auto p-10">
        <div class="md:w-2/3 lg:w-1/3 flex flex-col items-center gap-5 mx-auto">
            <div class="flex items-center gap-x-5">
                <Icon icon="material-symbols:e911-emergency-outline" class="text-6xl text-red-500" />
                <h1 class="text-3xl mt-2 font-medium">Emergency Hotlines</h1>
            </div>
